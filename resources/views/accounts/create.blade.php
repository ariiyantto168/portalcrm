...
<section class="content">
  ...
  <div class="box">
    ...
    <div class="box-body">
      {{ Form::open(array('url' => 'accounts/create-new', 'class' => 'form-horizontal')) }}
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <textarea name="billingaddres" rows="3"  class="form-control" required></textarea>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <textarea name="shippingaddres" rows="3"  class="form-control" required></textarea>
        </div>
      </div>

...
<section class="content">
  ...
  <div class="box">
    ...
    <div class="box-body">
    {{Form::open(array('url' => 'industries/update/'.$industries->idindustries, 'class' => 'form-horizontal'))}}
      <div class="form-group">
        <label class="col-sm-2 control-label">Name</label>
        <div class="col-sm-5">
          <input type="text" class="form-control" value="{{$industries->name}}" name="name" required>
        </div>
      </div>
